...
export class UsersGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  grid0RowSelect(event: any) {
    this.dialogService.open(EditUserComponent, { parameters: {Id: event.Id}, title: 'Edit User' });
  }

  grid0Add(event: any) {
    this.dialogService.open(AddUserComponent, { parameters: {}, title: 'Add User' });
  }
}
