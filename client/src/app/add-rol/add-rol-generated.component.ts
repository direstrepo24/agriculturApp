/*
  ...
  Modify add-rol.component.ts instead.
*/
...
export class AddRolGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createRol(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Rol!` });
    });
  }
}
