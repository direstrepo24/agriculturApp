/*
  ...
  Modify add-departamento.component.ts instead.
*/
...
export class AddDepartamentoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createDepartamento(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Departamento!` });
    });
  }
}
