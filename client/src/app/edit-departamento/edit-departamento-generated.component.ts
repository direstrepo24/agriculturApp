/*
  ...
  Modify edit-departamento.component.ts instead.
*/
...
export class EditDepartamentoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getDepartamentoById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateDepartamento(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Departamento` });
    });
  }
}
