/*
  ...
  Modify add-unidad-medida.component.ts instead.
*/
...
export class AddUnidadMedidaGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createUnidadMedida(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new UnidadMedida!` });
    });
  }
}
