/*
  ...
  Modify add-metodo-pago.component.ts instead.
*/
...
export class AddMetodoPagoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createMetodoPago(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new MetodoPago!` });
    });
  }
}
