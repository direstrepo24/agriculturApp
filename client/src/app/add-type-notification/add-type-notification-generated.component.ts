/*
  ...
  Modify add-type-notification.component.ts instead.
*/
...
export class AddTypeNotificationGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createTypeNotification(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new TypeNotification!` });
    });
  }
}
