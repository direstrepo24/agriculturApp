/*
  ...
  Modify edit-equipo.component.ts instead.
*/
...
export class EditEquipoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getEquipoById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateEquipo(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Equipo` });
    });
  }
}
