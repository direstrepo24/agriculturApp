/*
  ...
  Modify edit-tipo-producto.component.ts instead.
*/
...
export class EditTipoProductoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getTipoProductoById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateTipoProducto(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update TipoProducto` });
    });
  }
}
