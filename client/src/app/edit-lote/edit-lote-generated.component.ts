/*
  ...
  Modify edit-lote.component.ts instead.
*/
...
export class EditLoteGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getLoteById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateLote(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Lote` });
    });
  }
}
