/*
  ...
  Modify add-categorium.component.ts instead.
*/
...
export class AddCategoriumGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createCategorium(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Categorium!` });
    });
  }
}
