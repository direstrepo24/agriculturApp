/*
  ...
  Modify add-categoria-insumo.component.ts instead.
*/
...
export class AddCategoriaInsumoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createCategoriaInsumo(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new CategoriaInsumo!` });
    });
  }
}
