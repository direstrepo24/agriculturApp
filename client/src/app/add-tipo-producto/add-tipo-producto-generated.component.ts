/*
  ...
  Modify add-tipo-producto.component.ts instead.
*/
...
export class AddTipoProductoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createTipoProducto(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new TipoProducto!` });
    });
  }
}
