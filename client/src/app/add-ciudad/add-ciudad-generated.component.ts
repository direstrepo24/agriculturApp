/*
  ...
  Modify add-ciudad.component.ts instead.
*/
...
export class AddCiudadGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createCiudad(event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Ciudad!` });
    });
  }
}
