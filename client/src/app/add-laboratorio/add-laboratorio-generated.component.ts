/*
  ...
  Modify add-laboratorio.component.ts instead.
*/
...
export class AddLaboratorioGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createLaboratorio(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new Laboratorio!` });
    });
  }
}
