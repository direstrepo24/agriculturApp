/*
  ...
  Modify add-control-plaga.component.ts instead.
*/
...
export class AddControlPlagaGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createControlPlaga(event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new ControlPlaga!` });
    });
  }
}
