/*
  ...
  Modify edit-tipo-insumo.component.ts instead.
*/
...
export class EditTipoInsumoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getTipoInsumoById(this.parameters.Id)
    .subscribe((result: any) => {
      this.tipoinsumo = result;
    }, (result: any) => {
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateTipoInsumo(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update TipoInsumo` });
    });
  }
}
