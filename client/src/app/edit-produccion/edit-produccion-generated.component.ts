/*
  ...
  Modify edit-produccion.component.ts instead.
*/
...
export class EditProduccionGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.agriculturebd.getProduccionById(this.parameters.Id)
  ...
  form0Submit(event: any) {
    this.agriculturebd.updateProduccion(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      }
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Produccion` });
    });
  }
}
