/*
  ...
  Modify add-tipo-insumo.component.ts instead.
*/
...
export class AddTipoInsumoGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.agriculturebd.createTipoInsumo(event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new TipoInsumo!` });
    });
  }
}
